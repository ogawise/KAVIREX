...
<head>
    ...
    <script src="./assets/javascript/u_auth.js" defer></script>
...
<body>
    <main>
        ...
        <section class="main-container">
         ...
         <form class="general_login" action="./action/user_auth.php" method="POST" id="login">
        ...
        <P style="margin-bottom: 16px;"> Don't have an account? <a href ="register.php"> register </p>
